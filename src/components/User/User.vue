...
import {getUsers,page,filters,searchText} from "./User"
import dayjs from 'dayjs'
import { useRouter, useRoute } from 'vue-router'
const router = useRouter()

const route = useRoute()
debouncedWatch(searchText, () => getUsers(), { debounce: 500 })
...
<template>
  <div class="clients">
    ...
    <div class="body_clients">
      ...
      <div class="body_clients__client" v-for="user in filters.data">
